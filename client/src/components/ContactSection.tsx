...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-8 md:py-16 px-4 bg-white">
      <div className="container mx-auto">
        <h2 className="text-2xl md:text-4xl font-heading text-primary text-center mb-6 md:mb-12">CONTACT US</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
          <div>
            {/* Mobile-optimized 2-column layout for contact info */}
            <div className="grid grid-cols-2 gap-4 md:gap-6 md:block">
              <div className="mb-4 md:mb-8">
                <h3 className="text-xl md:text-2xl font-heading text-primary mb-2 md:mb-4">LOCATION</h3>
                <p className="text-muted-foreground text-sm md:text-base mb-1 md:mb-2">317 Ellicott Street</p>
                <p className="text-muted-foreground text-sm md:text-base mb-2 md:mb-4">Batavia, NY</p>
                <a 
                  href="https://maps.google.com/?q=317+Ellicott+Street,+Batavia,+NY" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-secondary text-sm md:text-base font-medium hover:underline"
                >
                  Get Directions
                </a>
              </div>
              ...
              <div className="mb-4 md:mb-8">
                <h3 className="text-xl md:text-2xl font-heading text-primary mb-2 md:mb-4">CONTACT</h3>
                <p className="text-muted-foreground text-sm md:text-base mb-1 md:mb-2">
              ...
              <div className="mb-4 md:mb-8 col-span-2">
                <h3 className="text-xl md:text-2xl font-heading text-primary mb-2 md:mb-4">HOURS</h3>
