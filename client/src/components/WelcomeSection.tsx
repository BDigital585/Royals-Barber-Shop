        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="grid grid-cols-5 gap-1 sm:gap-3">
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-white text-primary shadow-md hover:shadow-lg hover:scale-105 transition-all">
                  <FaComments size={20} />
                </div>
